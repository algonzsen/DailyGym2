...
public class ListaCardio extends RecyclerView.Adapter<ListaCardio.ViewHolder> implements View.OnClickListener {
    ...
    public ListaCardio(List<Rutinas> partesLista) {
