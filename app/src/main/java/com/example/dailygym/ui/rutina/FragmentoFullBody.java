...
public class FragmentoFullBody extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ListaFullBody adaptador = new ListaFullBody(listaPartes);
        ...
        adaptador.setOnCLickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if (nombre=="Rutina 3 días"){
                    Intent intent =new Intent(root.getContext(), RutinaFull3.class);
                    root.getContext().startActivity(intent);}
                if (nombre=="Rutina 4 días"){
                    Intent intent =new Intent(root.getContext(), RutinaFull4.class);
                    root.getContext().startActivity(intent);}
