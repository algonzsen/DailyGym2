...
public class ListaFuerza extends RecyclerView.Adapter<ListaFuerza.ViewHolder> implements View.OnClickListener {
    ...
    public ListaFuerza(List<Rutinas> partesLista) {
