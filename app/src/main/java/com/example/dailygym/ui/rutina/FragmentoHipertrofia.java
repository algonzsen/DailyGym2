...
public class FragmentoHipertrofia extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ListaHipertrofia adaptador = new ListaHipertrofia(listaPartes);
        ...
        adaptador.setOnCLickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if (nombre=="Rutina 3 días"){
                    Intent intent =new Intent(root.getContext(), RutinaHiper3.class);
                    root.getContext().startActivity(intent);}
                if (nombre=="Rutina 4 días"){
                    Intent intent =new Intent(root.getContext(), RutinaHiper4.class);
                    root.getContext().startActivity(intent);}
