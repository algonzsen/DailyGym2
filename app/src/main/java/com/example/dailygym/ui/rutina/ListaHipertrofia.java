...
public class ListaHipertrofia extends RecyclerView.Adapter<ListaHipertrofia.ViewHolder> implements View.OnClickListener {
    ...
    public ListaHipertrofia(List<Rutinas> partesLista) {
