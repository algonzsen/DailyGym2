...
public class Espalda extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        adaptador.setOnCLickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if (nombre=="Dominadas"){
                    Intent intent =new Intent(root.getContext(), com.example.dailygym.ejercicios.Dominadas.class);
                    root.getContext().startActivity(intent);}
                if (nombre=="Remo bajo"){
                    Intent intent =new Intent(root.getContext(), com.example.dailygym.ejercicios.RemoBajo.class);
                    root.getContext().startActivity(intent);}
                if (nombre=="Jalon"){
                    Intent intent =new Intent(root.getContext(), com.example.dailygym.ejercicios.Jalon.class);
                    root.getContext().startActivity(intent);}
                if (nombre=="Tiradas"){
                    Intent intent =new Intent(root.getContext(), com.example.dailygym.ejercicios.Tiradas.class);
                    root.getContext().startActivity(intent);}
