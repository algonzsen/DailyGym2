...
public class ListaBiceps extends RecyclerView.Adapter<ListaBiceps.ViewHolder> implements View.OnClickListener {
    ...
    public ListaBiceps(List<Ejercicios> partesLista) {
