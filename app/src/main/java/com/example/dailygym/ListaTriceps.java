...
public class ListaTriceps extends RecyclerView.Adapter<ListaTriceps.ViewHolder> implements View.OnClickListener {
    ...
    public ListaTriceps(List<Ejercicios> partesLista) {
