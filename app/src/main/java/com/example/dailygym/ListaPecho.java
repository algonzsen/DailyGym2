...
public class ListaPecho extends RecyclerView.Adapter<ListaPecho.ViewHolder> implements View.OnClickListener {
    ...
    public ListaPecho(List<Ejercicios> partesLista) {
