...
public class ListaPierna extends RecyclerView.Adapter<ListaPierna.ViewHolder> implements View.OnClickListener {
    ...
    public ListaPierna(List<Ejercicios> partesLista) {
