...
public class RecyclerViewAdaptador extends RecyclerView.Adapter<RecyclerViewAdaptador.ViewHolder> implements View.OnClickListener {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            nombre = (TextView)itemView.findViewById(R.id.text_biceps);
            fotoParte = (ImageView)itemView.findViewById(R.id.iv_biceps);
        }
    }

    public List<PartesModelo> partesLista;
    private View.OnClickListener listener;
    public RecyclerViewAdaptador(List<PartesModelo> partesLista) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_partescuerpo,parent,false);
