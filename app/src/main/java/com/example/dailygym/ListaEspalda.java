...
public class ListaEspalda extends RecyclerView.Adapter<ListaEspalda.ViewHolder> implements View.OnClickListener {
    ...
    public ListaEspalda(List<Ejercicios> partesLista) {
